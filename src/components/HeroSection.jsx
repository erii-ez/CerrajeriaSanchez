    ...
    <section style={{ backgroundColor: 'var(--navy)', color: 'white', padding: '40px 24px', position: 'relative' }}>
      <div className="content-container">
        ...
        <p style={{ color: 'var(--text-gray)', fontSize: '15px', lineHeight: '1.5', marginBottom: '32px' }}>
          ...
          <a href="tel:+524686893743" style={{ width: '100%', padding: '18px', backgroundColor: 'var(--orange)', color: 'white', border: 'none', borderRadius: '12px', fontSize: '18px', fontWeight: 'bold', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '8px', boxShadow: '0 8px 20px var(--orange-glow)', textDecoration: 'none', boxSizing: 'border-box' }}
        >
